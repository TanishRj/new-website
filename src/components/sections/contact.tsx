    ...
    <Container id="contact">
      <div className="flex flex-col items-center gap-4">
        ...
        <Typography variant="subtitle" className="max-w-xl text-center">
          What’s next? Feel free to reach out if you’re looking for a cybersecurity enthusiast, need insights on red teaming, or just want to connect and share knowledge.
        </Typography>
      </div>
